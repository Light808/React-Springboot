      ...
      <div className="refund-container">
              ...
              <div key={section.id} className={`refund-section ${isExpanded ? 'expanded' : ''}`}>
                ...
                >
                  <div className="rfd-section-header-content">
                    <Icon size={24} className="rfd-section-icon" />
                    <h2 className="rfd-section-title">{section.title}</h2>
                  </div>
                  {isExpanded ? (
                    <ChevronUp size={24} className="rfd-expand-icon" />
                  ) : (
                    <ChevronDown size={24} className="rfd-expand-icon" />
                  )}
                </button>
        ...
        <div className="refund-contact">
          ...
          <div className="rfd-contact-buttons">
            <a href="mailto:refunds@galaxystudio.com" className="rfd-contact-btn">
              <Mail size={20} />
              {t('Email Refund Team')}
            </a>
