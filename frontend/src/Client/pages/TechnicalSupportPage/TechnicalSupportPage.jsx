...
const TechnicalSupportPage = () => {
  ...
  const categories = [
    { id: 'all', name: t('All Issues'), icon: Settings },
    { id: 'website', name: t('Website Issues'), icon: Monitor },
    { id: 'mobile', name: t('Mobile App'), icon: Smartphone },
    { id: 'payment', name: t('Payment System'), icon: Shield },
    { id: 'performance', name: t('Performance'), icon: Zap },
    { id: 'browser', name: t('Browser Issues'), icon: Globe },
    { id: 'network', name: t('Network Issues'), icon: Wifi }
  ];
