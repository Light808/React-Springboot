  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: 24 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '8px 0 16px' }}>
        ...
        <button onClick={() => { addFunds(200000); window.location.reload(); }} style={{ marginLeft: 'auto', padding: '6px 10px', borderRadius: 6, border: 0, background: '#0ea5e9', color: '#fff' }}>Top up +200,000</button>
      </div>
