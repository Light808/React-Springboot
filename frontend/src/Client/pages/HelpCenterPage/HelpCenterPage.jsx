...
const HelpCenterPage = () => {
  ...
  const categories = [
    { id: 'all', name: t('All Topics'), icon: HelpCircle },
    { id: 'booking', name: t('Booking & Tickets'), icon: Ticket },
    { id: 'payment', name: t('Payment & Billing'), icon: CreditCard },
    { id: 'account', name: t('Account & Profile'), icon: User },
    { id: 'technical', name: t('Technical Issues'), icon: Settings },
    { id: 'mobile', name: t('Mobile App'), icon: Smartphone },
    { id: 'website', name: t('Website'), icon: Monitor }
  ];
              ...
              {popularArticles.map((article) => (
                <div key={article.id} className="article-card popular">
                  ...
                  <button className="read-more-btn">
                    {t('Read More')} <ChevronRight size={16} />
                  </button>
                </div>
              ))}
            </div>
